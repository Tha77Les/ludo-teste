...
export const PLAYERS = ['Azul', 'Amarelo', 'Verde', 'Vermelho'];

export const BASE_POSITIONS = {
    Azul: [500, 501, 502, 503],
    Verde: [600, 601, 602, 603],
    Vermelho: [700, 701, 702, 703],
    Amarelo: [800, 801, 802, 803]
};

export const START_POSITIONS = {
    Azul: 0, Verde: 26, Vermelho: 39, Amarelo: 13
};

export const HOME_ENTRANCE = {
    Azul: [100, 101, 102, 103, 104],
    Verde: [200, 201, 202, 203, 204],
    Vermelho: [300, 301, 302, 303, 304],
    Amarelo: [400, 401, 402, 403, 404]
};

export const HOME_POSITIONS = {
    Azul: 105, Verde: 205, Vermelho: 305, Amarelo: 405
};

export const TURNING_POINTS = {
    Azul: 50, Verde: 24, Vermelho: 37, Amarelo: 11
};
